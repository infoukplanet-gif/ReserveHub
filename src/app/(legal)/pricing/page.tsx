...
const plans = [
  {
    ...
    features: [
      { text: '来院予約管理', detail: '月30件まで' },
      { text: 'HP作成', detail: '基本テンプレート' },
      { text: '患者管理', detail: '100名まで' },
      { text: 'メール通知', detail: '来院予約確認・リマインド' },
      { text: '施術者管理', detail: '1名（オーナーのみ）' },
    ],
  ...
  },
  {
    ...
    price: '¥5,980',
    period: '/月（税込）',
    description: '複数施術者の院に',
    features: [
      { text: 'Standardの全機能', detail: '' },
      { text: '施術者管理', detail: '無制限' },
