...
### 意思決定・計画
- `planner` — 機能→タスク分解、実装順序決定、ロードマップ作成
- `think-tank` — 設計判断・技術選定前のマルチペルソナ討論

## スキル

### 開発
- `/init-project` — プロジェクト初期セットアップ（Next.js + Supabase + Prisma）
...
- `/seo-check [URL]` — SEO・パフォーマンス・アクセシビリティ監査
...
- `.claude/hooks/pre-commit.md` — pre-commit hook設定ガイド
